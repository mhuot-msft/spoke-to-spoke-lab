...
### REQ-1: Hub VNet
- VNet: vnet-hub (10.100.0.0/16)
- GatewaySubnet (10.100.0.0/27)
- VPN Gateway (VpnGw1 SKU): vpn-gw-hub

### REQ-2: Spoke 1 VNet (Databricks simulation)
- VNet: vnet-spoke-dbrx (10.101.0.0/16)
- Subnet: subnet-dbrx (10.101.1.0/24)
- Ubuntu 22.04 VM: vm-dbrx (Standard_B2s)
- NSG: nsg-dbrx (allow SSH from deployer IP)
- Public IP: pip-dbrx

### REQ-3: Spoke 2 VNet (ADLS)
- VNet: vnet-spoke-adls (10.102.0.0/16)
- Subnet: subnet-adls (10.102.1.0/24)
- Private endpoint subnet: subnet-pe (10.102.2.0/24)
...
### REQ-8: Validation
- Effective routes on nic-dbrx show 10.102.0.0/16 next hop = VirtualNetworkGateway
